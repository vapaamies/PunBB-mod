...
'Redirect time label' => 'Ожидание перенаправления',
'Redirect time help' => 'Если установить 0 секунд, страница перенаправления не будет выводиться',
...
'Setup reports' => 'Способ получения жалоб на сообщения и темы',
'Setup reports legend' => 'Получать сообщения',
'Reporting method' => 'Метод уведомления',
'Report internal label' => 'Через панель администрирования.',
'Report both label' => 'Через панель администрирования и по эл. почте администраторам из списка рассылки.',
'Report email label' => 'По эл. почте администраторам из списка рассылки.',
'Setup URL' => 'Схема URL (<abbr title="Search Engine Friendly">SEF</abbr> URLs) для страниц',
'Setup URL legend' => 'Схема URL',
'URL scheme info' => '<strong>ВНИМАНИЕ!</strong> Если выбрать схему, отличную от <strong>Default</strong>, необходимо скопировать/переименовать файл <em>.htaccess.dist</em> в <em>.htaccess</em> в корне форума. Сервер, на котором установлен форум, должен быть сконфигурирован с поддержкой mod_rewrite и должен разрешать использование файлов <em>.htaccess</em>. Если используется веб-сервер, отличный от Apache, пожалуйста, обратитесь к документации этого сервера.',
...
// Features section
'Features general' => 'Основные возможности PunBB, включаемые при надобности',
...
'Guest posting label' => 'Гости должны указать адрес эл. почты при отправке сообщений.',
...
'User info label' => 'Отображать местонахождение пользователя, дату регистрации, количество сообщений, адреса эл. почты и сайта в сообщениях.',
...
'Avatar directory help' => 'Относительно корневого каталога форума PunBB. PHP должен иметь право на запись в этот каталог.',
...
'Require rules label' => 'Обязать пользователей принимать правила форума перед прохождением регистрации.',
'Compose rules label' => 'Текст правил',
'Compose rules help' => 'В этом блоке можно использовать HTML.',
