...
{
    global $forum_url, $lang_pun_tags;
    return '<li><a href = "'.forum_link($forum_url['search_tag'], $tag_id).'"  title="'.$weight.' '.(($weight == 1) ? $lang_pun_tags['topic'] : $lang_pun_tags['topics']).'">'.$tag.'</a></li>';
}
...
function pun_tags_parse_string($text)
{
    ...
    if (utf8_strlen(forum_trim($text)) > 200)
