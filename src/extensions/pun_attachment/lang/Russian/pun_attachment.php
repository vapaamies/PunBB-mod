...
'Display small' => 'Изображения будут отображаться при просмотре или редактировании темы, если их размеры меньше заданных ниже:',
'Disable attachments' => 'Отключить вложения',
'Display icons' => 'Включить отображение значков',
'Create orphans' => 'Включите, если хотите разрешить бесхозные вложения.',
...
'Create orphans' => 'Разрешить бесхозные',
'Orphans help' => 'Если включить, вложения не будут удаляться из базы, если пользователь захочет удалить сообщение с этими вложениями.',
'Icons help' => 'Значки для вложений хранятся в каталоге FORUM_ROOT/extensions/attachment/img/. Чтобы добавить или изменить значки, используйте форму ниже. В первой колонке нужно вводить тип файла, в ячейке напротив следует вводить имя файла значка. Можно использовать следующие форматы: png, gif, jpeg и ico.',
...
'Show only "Orphans"' => 'Показать только бесхозные',
